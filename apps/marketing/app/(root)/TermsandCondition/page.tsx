          ...
          <div className="space-y-10">
            ...
            <section className="border-b border-gray-800 pb-8">
              ...
              <p className="text-gray-500 font-montserrat">
                ...
                Instagram or Meta Platforms, Inc. If your Instagram account is
                suspended or restricted, Our product/service may be unable to
                provide its features, and we are not liable for such
                limitations.
              </p>
            </section>
            <section className="border-b border-gray-800 pb-8">
