...
// Payment method icons (using emojis for simplicity, replace with actual icons)
...
export default function PayoutPage() {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [userId, isLoaded, apiRequest, router]);
    ...
    <div className="min-h-screen bg-[#F8F9FA]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Payout</h1>
          ...
          {paymentMethod === "bank" && (
            <div>
              ...
              <Button
                ...
                disabled={saving}
                className="bg-gray-900 hover:bg-black text-white rounded-lg px-6"
              >
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-100">
          ...
          <Button
            ...
            className="bg-gray-400 hover:bg-gray-500 text-white rounded-lg px-6"
          >
