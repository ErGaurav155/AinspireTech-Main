// API routes — single source of truth used by all apps AND the api server
export const API_ROUTES = {
  // Auth
  WEBHOOK_CLERK: "/webhooks/clerk",
  // User
  USER_ACTIONS: "/user/actions",

  // Web chatbot
  WEB_CREATE: "/web/create",
  WEB_CHATBOT: (id: string) => `/web/chatbot/${id}`,
  WEB_FAQ: (id: string) => `/web/faq/${id}`,
  ...
  // Razorpay
  RAZORPAY_CREATE_SUB: "/razorpay/create-sub",
  RAZORPAY_VERIFY_SUB: "/razorpay/verify-sub",
...
export const productSubscriptionDetails: Record<
  string,
  {
    ...
    description: {
      bgcolor: string; // Background color for product display
      heading: string; // Heading text for the product
      subheading: string; // Subheading text for the product
    };
...
> = {
  ...
  //   },
  //   inclusions: [
  //     { label: "Product recommendations", isIncluded: true },
  //     { label: "Cart management", isIncluded: true },
  //     { label: "User behavior analytics", isIncluded: true },
  ...
  "chatbot-lead-generation": {
    ...
    inclusions: [
      ...
      { label: "Email Notifications", isIncluded: true },
      { label: "Advanced Analytics", isIncluded: true },
      { label: "Priority support", isIncluded: true },
      { label: "Remove RocketReplai watermark", isIncluded: true },
